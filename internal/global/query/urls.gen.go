...
func newUrl(db *gorm.DB, opts ...gen.DOOption) url {
	...
	_url.ShortURL = field.NewString(tableName, "short_url")
	_url.LongURL = field.NewString(tableName, "long_url")
...
func (u *url) updateTableName(table string) *url {
	...
	u.LongURL = field.NewString(table, "long_url")
